...
export const verificarAuth = async function (req, res, next){ // Serve pra evitar repetição de requisição.
    try{
        const authHeader = req.headers.authorization; //Puxa o token bearer do header de autorização.
...
// =============================================================================================
//                             MIDDLWARE DE PRIORIDADE DE CARGO
// =============================================================================================
